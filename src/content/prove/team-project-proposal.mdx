...
Over the final 4 weeks of the course, you will work in teams to design and build a fully functional full-stack web application. This capstone project is your opportunity to apply the concepts and technologies learned throughout the course to a real-world problem of your choosing.
...
## **02** Setup project and team

Visit [course tools](https://course-tools.netlify.app/wdd360/) and create your team and your project. We will be using this tool to do some peer reviews of the projects later in the semester. The passcode is the same as the one for the self evaluations. 

>If you are unsure what section you are in, the easiest place to see this would be in ILearn. If you click on the Courses button as if you were going to change to a different course you can see the section you are in listed there. If you are still unsure ask your instructor.

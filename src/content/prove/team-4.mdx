...
11. Format and return the data as a JSON object with `count`, `next` and `previous` fields, along with an array of objects that contain all of the product information. 
sults.

...
>Do not use AI to generate code for this assignment. You may use AI tools to help you understand concepts, ask specific questions (ie How so I create a prop in svelte5?) and troubleshoot, but write your own code for this assignment.

---
title: Testing Code Part 2: Choosing What to Test
...
In this second testing assignment, you will focus less on *how to write a test* and more on *what to test with each kind of test*.

Assume you are already familiar with:

- the article readings,
- the first testing activity,
